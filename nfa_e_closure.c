/*==============================================================================
 |   Problem:  Find the ε-closure of all states of an NFA with ε-transitions   |
 |   Author:   Alfred Thomas                                                   |
 |   Date:     25/4/2024                                                       |
 |   To Run:   Enter number of states, no. of transitions, and transitions     |
 |             in the form state symbol state without space e.g. q0aq1         |
 +-----------------------------------------------------------------------------*/
