/*==============================================================================
 |   Problem:  Implement target code generation from three address code        |
 |   Author:   Alfred Thomas                                                   |
 |   Date:     13/9/25                                                         |
 |   To Run:   Enter some three address codes like a = b + c , c = d * e       |
 |             move first opnd to ax, operate with 2nd opnd and ax to result   |
 +-----------------------------------------------------------------------------*/
#include<stdio.h>
#include<string.h>
#include<ctype.h>
